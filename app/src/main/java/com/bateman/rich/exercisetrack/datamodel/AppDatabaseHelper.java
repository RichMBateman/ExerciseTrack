...
public class AppDatabaseHelper {
    ...
    public static final int SQLITE_INT_FALSE = -;
     ...
     */
    public static void createTriggerOnDeleteParentRecord(SQLiteDatabase db, String parentTableName, String childTableName,
                                                         String parentIdColName, String childFkIdColName) {
        String sSqlStatement = "CREATE TRIGGER Remove_DaySchedule"
